...
let colors = document.querySelectorAll('.filters-color');
let activeColor = document.querySelector('.active-color');
let buttonHideFilters = document.querySelector('.category-services__button-hide');
let buttonShowFilters = document.querySelector('.category-services__button-show');
let filter = document.querySelector('.category-services__filters');

let filters  = {
    hideFilters() {
        buttonHideFilters.addEventListener('click', () => {
            filter.classList.add('disabled-filters');
            buttonHideFilters.classList.toggle('inactive-button');
            buttonShowFilters.classList.toggle('active-button');
        })
    },
    showFilters() {
        buttonShowFilters.addEventListener('click', () => {
            filter.classList.remove('disabled-filters');
            buttonHideFilters.classList.toggle('inactive-button');
            buttonShowFilters.classList.toggle('active-button');
        })
    },
    chooseColor() {
        document.addEventListener('click', (event) => {
            arrColors = [...colors];
            let index = arrColors.indexOf(event.target);
            if (event.target.classList.contains('filters-color')) {
                if (activeColor !== event.target) {
                    colors[index].classList.add('active-color'); 
